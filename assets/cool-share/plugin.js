(function ($) {
	...
	$.fn.shareButtons = function (options) {
		...
		var shareURLs = {
			'facebook' : 'https://www.facebook.com/shiva.shankar.94043626',
			'linkedin' : 'http://in.linkedin.com/in/shiv6146',
			'googlePlus' : 'https://plus.google.com/+shivashankar6146',
			'twitter' : 'https://twitter.com/shiv6146',
			'github': 'https://github.com/shiv6146'
		};
		...
		this.each(function(i){
			...
			if(options.github) {
				socialButtonsPopUp.append($('<a class="fa fa-github" href="'+ shareURLs.github + '" ></a>'));
			}
		...
		socials.width(socialLength * 110).css({'margin-left': marginLeft - ((socialLength-1) * 55),'margin-top':'90px'});
